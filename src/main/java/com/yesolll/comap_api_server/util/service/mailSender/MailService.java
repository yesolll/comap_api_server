...
public class MailService {
    ...
    public void sendTemplateMessage(MailDto mailDto) throws MessagingException {
        ...
        //템플릿에 전달할 데이터 설정: TODO
        HashMap<String, String> emailValues = new HashMap<>();
        emailValues.put(
                "authUrl", "http://localhost:13080/api/v1/member"
                .concat("/authentication?authKey=")
                .concat(mailDto.getAuthKey())
        );
        ...
        helper.addInline("image", new ClassPathResource("static/images/image-1.png"));
